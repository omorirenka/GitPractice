...
/**
 * Servlet implementation class Kadai16ExecuteServlet
 */
...
public class Kadai16ExecuteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = Account16DAO.registerAccount(account);
		
		String path = "";
		if(result == 1) {
			session.removeAttribute("input_dateK16");
			path = "WEB-INF/view/kadai16-success.jsp";
		}else {
			path = "WEB-INF/view/kadai16-form.jsp?error=1";
		}
